...
<body>
    <header class="header">
        ...
        <nav class="nav-bar">
            ...
            <a href="../php/verMaestros.php">Administración</a>
    ...
    <main class="container">
        <section class="form-section">
            <form action="../php/registrarMaestro.php" method="POST">
                ...
                <button type="submit" name="registrarUsuario">Registrar</button>
            </form>
        </section>
    </main>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (urlParams.has('error')) {
                const errorMessages = {
                    ...
                    'matricula_existente': 'La matrícula ya está registrada',
                    'correo_existente': 'El correo electrónico ya está en uso',
                    'error_registro': 'Ocurrió un error al registrar el maestro'
                };
